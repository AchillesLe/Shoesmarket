        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('seller.register.post') }}">
                        ...
                        <div class="form-group{{ $errors->has('optradiosex') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                             ...
                             @if ($errors->has('optradiosex'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('optradiosex') }}</strong>
                                    </span>
                            @endif
                        </div>

                        <div class="form-group{{ $errors->has('cmnd') ? ' has-error' : '' }}">
                            <label for="cmnd" class="col-md-4 control-label">CMND</label>

                            <div class="col-md-6">
                                <input id="cmnd" type="number" class="form-control" name="cmnd" value="{{ old('cmnd') }}" required autofocus>
